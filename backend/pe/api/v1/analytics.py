...
from pe.core.dependencies import get_db_session, get_current_user
from pe.core.rbac import require_role, UserRole
...
async def get_competency(
    ...
    try:
        ...
        state_velocities = await _fetch_all(db, """
            WITH state_times AS (
                SELECT
        ...
        # Intervention rate
        intervention_rate = await _fetch_one(db, """
            SELECT
        ...
        de_escalation = await _fetch_all(db, """
            SELECT
        ...
        osce_scores = await _fetch_all(db, """
            SELECT
        ...
        return _demo_fallback() or {"state_velocities": [], "intervention_rate": {"total_turns": 0, "input_guard_triggers": 0, "rate": 0}, "de_escalation_efficacy": [], "osce_scores": []}
...
async def get_compliance(
    ...
    try:
        ...
        return _demo_fallback() or {"phi_interceptions": {"total_intercepted": 0, "by_pattern": [], "trend": "stable"}, "audit_chain": {}, "inference_latency": []}
