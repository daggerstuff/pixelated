...
def main():
    ...
    parser.add_argument(
        "--trust-remote-code", action="store_true", help="Whether to trust remote code when loading models"
    )
    ...
    if not args.skip_verification:
        print("[Verification] Testing load of merged model...")
        try:
        ...
        print("[Verification] Skipped as requested")
