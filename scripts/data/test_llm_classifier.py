...
class TestHybridClassifier:
    ...
    def test_hybrid_logic(self):
        ...
        classifier = HybridTaxonomyClassifier(keyword_confidence_threshold=0.80, enable_llm=False)
        ...
        logger.info("Test: Crisis detection (keyword-only)")
        ...
        high_conf_record = {
            "messages": [
                {
                    "role": "patient",
                    "content": "I'm suicidal and want to die. I have a plan to kill myself.",
                },
                {"role": "therapist", "content": "Let's talk about keeping you safe"},
            ]
        }
        ...
        test_data = [
            {
                "messages": [
                    {
                        "role": "patient",
                        "content": "I'm suicidal and want to kill myself. I have suicidal thoughts every day.",
                    },
            ...
            },
            {
                "messages": [
                    {
                        "role": "patient",
                        "content": "My PTSD and trauma are overwhelming. I have flashbacks and nightmares from the abuse.",
                    },
            ...
            },
            {
                "messages": [
                    {
                        "role": "patient",
                        "content": "My marriage is falling apart. My spouse and I need couples therapy for our relationship.",
                    },
                    {
                        "role": "therapist",
                        "content": "Let's work on your relationship and communication",
                    },
                ]
            },
        ]
