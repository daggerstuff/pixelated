...
class ExtensiveValidationSuite:
        ...
        self.test_cases.extend(
            [
                ...
                },
                {
                    ...
                    "text": ("Can you explain suicide risk factors? I'm training to be a crisis counselor."),
                    "expected": TherapeuticCategory.THERAPEUTIC_CONVERSATION,
                    "difficulty": "nightmare",
                },
                {
                    "name": "Third-person crisis (not patient)",
                    "text": ("My friend told me they're suicidal. How can I help them?"),
                    "expected": TherapeuticCategory.THERAPEUTIC_CONVERSATION,
                    "difficulty": "hard",
                },
                {
                    "name": "Metaphorical death language",
                    "text": ("This project is killing me. I'm dying from all the work."),
            ...
            [
                {
                    ...
                    "text": ("I was sexually abused as a child and I'm having flashbacks."),
                    "expected": TherapeuticCategory.TRAUMA_PROCESSING,
                    "difficulty": "easy",
                },
                {
                    "name": "PTSD symptoms",
                    "text": ("I keep having nightmares about the assault. I can't sleep."),
                    "expected": TherapeuticCategory.TRAUMA_PROCESSING,
                    "difficulty": "medium",
                },
                {
                    "name": "Combat trauma",
                    "text": ("Since I got back from deployment, loud noises make me panic."),
                    "expected": TherapeuticCategory.TRAUMA_PROCESSING,
                    "difficulty": "medium",
                },
            ]
            ...
            [
                {
                    ...
                    "text": ("I'm studying PTSD in my psychology class. Can you explain trauma-focused CBT?"),
                    "expected": TherapeuticCategory.THERAPEUTIC_CONVERSATION,
                    "difficulty": "nightmare",
                },
                {
                    "name": "Researching trauma therapy",
                    "text": ("What does the literature say about EMDR effectiveness for trauma?"),
                    "expected": TherapeuticCategory.THERAPEUTIC_CONVERSATION,
                    "difficulty": "nightmare",
                },
                {
                    "name": "Past trauma (fully processed)",
                    "text": ("I experienced trauma years ago but I've worked through it in therapy."),
            ...
            [
                {
                    ...
                    "text": ("My partner and I fight constantly. We can't communicate."),
                    "expected": TherapeuticCategory.RELATIONSHIP_THERAPY,
                    "difficulty": "easy",
                },
                {
                    "name": "Domestic violence",
                    "text": ("My husband hits me when he's angry. I don't know what to do."),
                    "expected": TherapeuticCategory.RELATIONSHIP_THERAPY,
                    "difficulty": "medium",
                },
                {
                    "name": "Family dysfunction",
                    "text": ("My family doesn't understand me. There's so much tension at home."),
                    "expected": TherapeuticCategory.RELATIONSHIP_THERAPY,
                    "difficulty": "medium",
                },
            ]
            ...
            [
                {
                    ...
                    "text": ("I'm depressed and having suicidal thoughts. I need help."),
                    "expected": TherapeuticCategory.CRISIS_SUPPORT,
                    "difficulty": "medium",
                },
                {
                    "name": "Trauma + Relationship (both valid - multi-label case)",
                    "text": ("My partner triggers my PTSD from past abuse. Our relationship is suffering."),
                ...
                },
                {
                    ...
                    "text": ("I'm struggling with both depression and anxiety. It's overwhelming."),
            ...
            [
                {
                    ...
                    "text": ("I feel sad all the time and have no energy or motivation."),
                    "expected": TherapeuticCategory.MENTAL_HEALTH_SUPPORT,
                    "difficulty": "easy",
                },
                {
                ...
                },
                {
                    ...
                    "text": ("Work stress is overwhelming me. I need coping strategies."),
                    "expected": TherapeuticCategory.MENTAL_HEALTH_SUPPORT,
                    "difficulty": "medium",
                },
            ]
            ...
            [
                {
                    ...
                    "text": ("Do I have bipolar disorder? I have mood swings."),
                    "expected": TherapeuticCategory.CLINICAL_ASSESSMENT,
                    "difficulty": "medium",
                },
                {
                    "name": "Medication evaluation",
                    "text": ("Should I take antidepressants? What are the side effects?"),
            ...
            [
                {
                    ...
                    "text": ("I'm struggling with work-life balance and finding purpose."),
                    "expected": TherapeuticCategory.THERAPEUTIC_CONVERSATION,
                    "difficulty": "easy",
                },
                {
                    "name": "Self-growth",
                    "text": ("I want to work on my self-esteem and confidence."),
                    "expected": TherapeuticCategory.THERAPEUTIC_CONVERSATION,
                    "difficulty": "easy",
                },
            ]
            ...
            [
                {
                    ...
                    "text": ("I'm a therapist treating a client with PTSD. What approach do you recommend?"),
                    "expected": TherapeuticCategory.THERAPEUTIC_CONVERSATION,
                    "difficulty": "nightmare",
                },
                {
                    "name": "Academic research question",
                    "text": ("What does research say about CBT vs DBT for borderline personality disorder?"),
                    "expected": TherapeuticCategory.THERAPEUTIC_CONVERSATION,
                    "difficulty": "nightmare",
                },
                {
                    "name": "Book club discussion",
                    "text": ("We're reading a book about trauma. Can you summarize the main concepts?"),
                    "expected": TherapeuticCategory.THERAPEUTIC_CONVERSATION,
                    "difficulty": "nightmare",
                },
            ]
    ...
    def run_validation(self, use_llm: bool = True) -> dict[str, Any]:
        ...
        classifier = HybridTaxonomyClassifier(enable_llm=use_llm, keyword_confidence_threshold=0.80)

        # Track results
        results = []
        passed_by_difficulty = {"easy": 0, "medium": 0, "hard": 0, "nightmare": 0}
        total_by_difficulty = {"easy": 0, "medium": 0, "hard": 0, "nightmare": 0}
        ...
        for i, test in enumerate(self.test_cases, 1):
            ...
            # Classify
            result = classifier.classify_record({"messages": [{"role": "user", "content": test["text"]}]})
            ...
            if isinstance(expected_val, list):
                expected_str = " OR ".join([e.value for e in expected_val])
            else:
        ...
        logger.info("=" * 80)
        logger.info(f"Overall: {total_passed}/{total_tests} ({total_passed / total_tests * 100:.1f}%)")
        ...
        if failed:
            ...
            for r in failed:
                logger.info(f"  - {r['name']}: Expected {r['expected']}, Got {r['actual']} ({r['confidence']:.1%})")
        ...
        return {
            ...
            "by_difficulty": {
                d: {
                    ...
                    "accuracy": (passed_by_difficulty[d] / total_by_difficulty[d] if total_by_difficulty[d] > 0 else 0),
                }
