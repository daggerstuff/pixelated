...
export BACKUP_RCLONE_EXCLUDE_EXTRA="node_modules/**,.git/**,.venv/**,venv/**,__pycache__/**,.nvm/**,.vscode-server/**,.avm/**,.bun/**,.docker/**,google-cloud-sdk/**,Downloads/**,Music/**,Videos/**,Pictures/**,Desktop/**,rclone-current-linux-amd64.zip,Terax_0.8.2_amd64.deb,.npm/**,.local/**,.rustup/**,.cargo/**,.cache/**,.casino-postgres/**,.payram-core/**,.gemini/**,.hermes/**,.pnpm-store/**,.vercel/**,.ruff_cache/**,.hypothesis/**"
