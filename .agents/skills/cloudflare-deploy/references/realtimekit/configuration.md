...
Configuration guide for RealtimeKit setup, client SDKs, and wrangler
integration.
...
**Required Permissions**: API token with **Realtime / Realtime Admin**
permissions
...
RealtimeKit can use Cloudflare's TURN service for connectivity through
...
TURN automatically configured when enabled in account - no client-side changes
needed.
