...
**Get Accounts (via API):** Use Cloudflare API directly or custom dynamic
resources.
...
**Use:** Advanced deployments (canary, blue-green). Most apps should use
`WorkerScript` (auto-versioning).
