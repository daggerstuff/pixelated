...
Routes queries to nearest replica for lower latency. Writes always go to
primary.
...
**Use cases**: Server-side scripts, CI/CD migrations, administrative tools,
non-Worker integrations
