...
**History Change Trigger (Recommended):** Configure in dashboard - no code
needed, Zaraz auto-detects route changes.
...
**Worker Variables** - Compute dynamic values server-side, use as
