...
**Token-based tunnels** = config source: Cloudflare **Locally-managed tunnels**
= config source: local
...
**Pros:** Version control, multi-environment, offline edits **Cons:** Requires
file distribution, manual restarts
...
Configure routes in dashboard: **Zero Trust** > **Networks** > **Tunnels** >
