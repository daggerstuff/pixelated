...
Exclude query strings from cache key to counter randomized query parameter
attacks.
...
**Rationale**: Attackers randomize query strings (`?random=123456`) to bypass
cache. Excluding query params ensures cache hits absorb attack traffic.
