...
**Note on Smart Shield Evolution:** Argo Smart Routing is being integrated into
Smart Shield. Configuration methods below remain valid; Terraform and IaC
patterns unchanged.
...
Before enabling Argo Smart Routing, ensure billing is configured for the
account:
...
**Note:** Attempting to enable Argo without billing configured will result in
`editable: false` in API responses.
