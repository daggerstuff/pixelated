...
Expert guidance for building, deploying, and optimizing Cloudflare Workers
applications.
...
**Key principle**: Workers use web platform APIs wherever possible for
portability.
...
- [Configuration](./configuration.md) - wrangler.jsonc setup, bindings,
  environments
