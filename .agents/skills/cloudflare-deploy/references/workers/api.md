...
Hibernation automatically suspends inactive connections (no CPU cost), wakes on
events
...
**When to use DOs**: Real-time collaboration, rate limiting, strongly consistent
state
...
**Benefits**: Type-safe method calls, no HTTP overhead, share code between
Workers
...
- [KV](../kv/README.md), [D1](../d1/README.md), [R2](../r2/README.md),
  [Durable Objects](../durable-objects/README.md), [Queues](../queues/README.md)
