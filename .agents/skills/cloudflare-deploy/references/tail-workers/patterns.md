...
**Note:** Most integrations require custom tail handler implementation. See
...
Dynamic dispatch sends TWO events per request. Filter by `scriptName` to
distinguish dispatch vs user Worker events.
