...
**File Extensions**: ico, jpg, png, jpeg, gif, css, js, tif, tiff, bmp, pict,
webp, svg, svgz, class, jar, txt, csv, doc, docx, xls, xlsx, pdf, ps, pls, ppt,
pptx, ttf, otf, woff, woff2, eot, eps, ejs, swf, torrent, midi, mid, m3u8, m4a,
mp3, ogg, ts  
...
Only available for HTTPS/TLS traffic. Missing for Worker-routed traffic or HTTP
requests.
...
- **Exempt corporate proxies**: For B2B traffic via
