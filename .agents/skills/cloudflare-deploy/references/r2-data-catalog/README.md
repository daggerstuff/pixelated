...
Expert guidance for Cloudflare R2 Data Catalog - Apache Iceberg catalog built
into R2 buckets.
...
R2 Data Catalog is a **managed Apache Iceberg REST catalog** built directly into
R2 buckets. It provides:
...
- **Public beta** - Available to all R2 subscribers, no extra cost beyond R2
  storage
...
- **Vended credentials** - Temporary S3 credentials catalog provides for data
  access
...
- Supports: namespaces, tables, snapshots, compaction, time-travel, table
  maintenance
