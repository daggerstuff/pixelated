...
**Web Analytics is dashboard-only** - no programmatic API. This covers beacon
integration.
...
**Use `spa: true` for:** React Router, Vue Router, Next.js, Nuxt, Gatsby,
SvelteKit, Angular

**Use `spa: false` for:** Traditional server-rendered (PHP, Django, Rails,
WordPress)
