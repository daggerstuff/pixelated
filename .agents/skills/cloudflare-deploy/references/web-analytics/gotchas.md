...
**Fix:** Migrate to History API (`BrowserRouter`, not `HashRouter`). No
workaround for hash routing.
...
**Web Analytics excels at:** Core Web Vitals, basic traffic, privacy compliance,
