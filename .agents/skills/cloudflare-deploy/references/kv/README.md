...
Globally-distributed, eventually-consistent key-value store optimized for high
read volume and low latency.
...
**Use cases:** Config storage, user sessions, feature flags, caching, A/B
testing
...
- [configuration.md](./configuration.md) - wrangler.jsonc setup, namespace
  creation, TypeScript types
...
- [gotchas.md](./gotchas.md) - Eventual consistency, concurrent writes, value
  limits
