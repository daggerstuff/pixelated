...
Common mistakes, security best practices, and troubleshooting for Cloudflare
TURN.
...
These events require ICE restart (see
[patterns.md](./patterns.md#ice-restart-pattern)):
...
Reference:
[RFC 8445 Section 2.4](https://datatracker.ietf.org/doc/html/rfc8445#section-2.4)
...
3. Set `iceTransportPolicy: 'all'` to try direct first (use `'relay'` only when
   necessary)
