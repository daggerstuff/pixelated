...
- **Pages**: Static sites, JAMstack, frameworks, git workflow, file-based
  routing
- **Workers**: Pure APIs, complex routing, WebSockets, scheduled tasks, email
  handlers
...
2. [configuration.md](./configuration.md) - Project setup, wrangler.jsonc,
   bindings
...
- [gotchas.md](./gotchas.md) - Build issues, limits, debugging, framework
  warnings
