...
2. `http_request_firewall_managed` - Managed rulesets (pre-configured
   protection)
...
**Note**: Skip rules in custom phase can skip managed/ratelimit phases, but not
vice versa (execution order).
