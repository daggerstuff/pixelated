...
**Solution:** Add destination, check inbox for verification email, click link.
Verify status: `GET /zones/{id}/email/routing/addresses`
...
**Solution:** Check priority (lower=first), verify exact match, confirm
