...
Bindings expose resources to workers. ES modules: `env.BINDING`, Service
workers: globals.
...
**Note:** Remote bindings require network access and valid Cloudflare API
credentials.
...
See [patterns.md](./patterns.md) for multi-service examples,
[gotchas.md](./gotchas.md) for config errors.
