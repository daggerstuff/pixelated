...
**Cause:** Cross-connect not installed, RX/TX fibers reversed, wrong fiber type,
or low light levels **Solution:**
...
**Cause:** Physical issue, low light (<-20 dBm), optic mismatch, or dirty
connectors **Solution:**
...
**Cause:** Wrong IP addressing, wrong ASN, password mismatch, or firewall
blocking TCP/179 **Solution:**
...
**Cause:** MTU mismatch, fragmentation, single GRE tunnel (v1), or routing
...
**Solution:** Check
[locations PDF](https://developers.cloudflare.com/network-interconnect/static/cni-locations-2026-01.pdf)
for valid codes
...
**Solution:** Cannot fully automate. Order in partner portal, notify CF account
team.
