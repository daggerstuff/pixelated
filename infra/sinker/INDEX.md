...
This file cross-references every artifact in this tree with the
mission-side documents and worker-side skill that should reference it.
...
Worker MUST write to these paths. orchestrator aggregates the contents to
update `validation-state.json` for the 11 VAL-INFRA-* assertions once
