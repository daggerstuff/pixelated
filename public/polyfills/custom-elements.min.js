!(function () {
  try {
    ...
    n &&
      ...
      (e._sentryDebugIds[n] = "6473e1b2-9a77-5e72-8234-df812be4df83"));
  } catch (e) {}
})();
(function () {
  /*
...
*/
    ...
    for (var f = a; f; ) {
      if (f.nodeType === Node.ELEMENT_NODE) {
        ...
        if ((c = c.__CE_shadowRoot))
          for (c = c.firstChild; c; c = c.nextSibling) M(c, b, d);
      }
  ...
  function P(a, b, d, f) {
    ...
    if (a.shadyDomFastWalk && c && c.inUse) {
      if ((b.nodeType === Node.ELEMENT_NODE && d(b), b.querySelectorAll))
        for (
          a = c.nativeMethods.querySelectorAll.call(b, "*"), b = 0;
          b < a.length;
          b++
        )
          d(a[b]);
  ...
  function T(a, b) {
    try {
      var d = b.ownerDocument,
        f = d.__CE_registry;
      var c =
        f && (d.defaultView || d.__CE_isImportDocument)
          ? W(f, b.localName)
          : void 0;
  ...
  function Ba(a, b, d) {
    ...
    try {
      ...
      var l =
        ((f = e("attributeChangedCallback")) && d.observedAttributes) || [];
    } catch (m) {
      throw m;
    } finally {
      a.A = !1;
  ...
  function Aa(a) {
    if (!1 !== a.i) {
      a.i = !1;
      for (var b = [], d = a.v, f = new Map(), c = 0; c < d.length; c++)
        f.set(d[c], []);
      V(a.h, document, {
        upgrade: function (k) {
