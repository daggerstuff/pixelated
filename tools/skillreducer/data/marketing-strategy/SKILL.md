...
5. Choose market category that sets buyer expectations.

## KPIs to track

- Win rate vs top 3 competitors
- Time-to-first-value for new segments
...
```
Overview | Strengths | Weaknesses | Landmines | Objection handling
```
