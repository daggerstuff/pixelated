...
This folder is **only for paper / benchmark evaluation** (SkillsBench,
...
Paper: [arXiv:2606.01139](https://arxiv.org/abs/2606.01139) · Parent docs:
[../README.md](../README.md)
...
Large upstream **`data/`** bundles are **not** vendored. Clone
...
`--manifest-kind` must be one of: `skillsbench` | `skilllearnbench` |
`alfworld`.  
...
`skillreducer reduce` / Stages 1–3 and normal `skillrevise` on your own
`tasks.json` do **not** need this folder’s harnesses. Keep benchmark deps and
datasets out of day-to-day SkillReducer workflows.
