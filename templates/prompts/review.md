...
{
  "verdict": "approve",
  "reasoning": "Implementation matches spec. Tests cover happy path and error cases. Types are correct.",
  "feedback": "",
  "follow_up_tasks": []
}
```
...
```json
{
  ...
  "reasoning": "Core logic is correct but error handling is incomplete.",
  "feedback": "Add try/except around the HTTP call in fetch_data() — network errors will crash the agent. Also add a test for the timeout case.",
  "follow_up_tasks": []
}
```
