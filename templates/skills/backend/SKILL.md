\n\n--- name: backend description: Python server code, APIs, async, strict
typing. trigger_keywords:
...
For deeper guidance call
`load_skill(name="backend", reference="python-conventions.md")` (style rules),
`reference="test-patterns.md"` (pytest idioms), or
