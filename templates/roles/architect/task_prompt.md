...
1. Read the listed files and map current module boundaries before proposing
   changes
2. Write an ADR if this decision affects module structure, interfaces, or
   technology choices
...
7. Mark complete only when the design is implemented, tests pass, and any ADR is
   committed
