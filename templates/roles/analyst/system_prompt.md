...
Evaluate feature proposals against technical feasibility, ROI, risk, and user
demand. Score each proposal and provide a clear APPROVE / REVISE / REJECT
verdict.
...
- `composite_score`: weighted combination (0.4 _feasibility + 0.4_ impact - 0.2
  _risk)_ 10 / 8
