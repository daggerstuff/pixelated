...
describe('Session ID Validation', () => { 
    ...
    it('validates session IDs with hyphens', () => { 
        const sessionIdWithHyphens = '123e4567-e89b-42d3-a456-426614174000' 
        expect(InputValidator.validateSessionId(sessionIdWithHyphens)).toBe(true) 
    }) 

    it('invalidates session IDs without hyphens', () => { 
        const sessionIdWithoutHyphens = '123e4567e89b42d3a456426614174000' 
        expect(InputValidator.validateSessionId(sessionIdWithoutHyphens)).toBe(false) 
    }) 

    it('validates session IDs with lowercase letters', () => { 
        const sessionIdWithLowercase = '123e4567-e89b-42d3-a456-426614174000' 
        expect(InputValidator.validateSessionId(sessionIdWithLowercase)).toBe(true) 
    }) 

    it('invalidates session IDs with uppercase letters', () => { 
        const sessionIdWithUppercase = '123E4567-E89B-42D3-A456-426614174000' 
        expect(InputValidator.validateSessionId(sessionIdWithUppercase)).toBe(false) 
    }) 
})