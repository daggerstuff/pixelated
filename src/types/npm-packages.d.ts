...
declare module "typeorm" {
  ...
  export function Entity(tableName?: string | { name?: string; schema?: string }): ClassDecorator;
  ...
  export function PrimaryColumn(options?: { type?: string; length?: number }): PropertyDecorator;
