...
declare namespace VitestCompat {
  ...
  type MockReturn<TFn> = TFn extends (...args: never[]) => Promise<infer R>
    ...
    : TFn extends (...args: never[]) => infer R
      ? R
      : unknown;
  type MockFunction<T extends (...args: any[]) => any = (...args: any[]) => any> = T & {
    mock: {
      calls: Parameters<T>[];
      instances: unknown[];
...
declare global {
  const vi: {
    fn: <T extends (...args: any[]) => any>(fn?: T) => VitestCompat.MockFunction<T>;
    ...
    >;
    mockResolvedValue: (value: unknown) => VitestCompat.MockFunction<(...args: any[]) => Promise<unknown>>;
    mockRejectedValue: (value: unknown) => VitestCompat.MockFunction<(...args: any[]) => Promise<never>>;
  };
