...
import { AppError, ValidationError, NotFoundError, UnauthorizedError, ForbiddenError, ConflictError, errorHandler, notFoundHandler, asyncHandler } from '../error-handler'
...
describe('error-handler middleware', () => {
  ...
  describe('errorHandler', () => {
    it('should handle standard Error with 500 status', () => {
      ...
      errorHandler(error as any, req as unknown as Request, res as unknown as Response, next)
  ...
  describe('notFoundHandler', () => {
    it('should generate NotFoundError and call errorHandler', () => {
      notFoundHandler(req as unknown as Request, res as unknown as Response, next)
