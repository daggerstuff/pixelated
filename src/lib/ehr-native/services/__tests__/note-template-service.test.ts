...
describe('NoteTemplateService', () => {
  describe('listTemplates', () => {
    ...
    it('filters templates by modality', () => {
      ...
      const therapy = noteTemplateService.listTemplates('individual-therapy' as NoteModality)
    ...
    it('returns empty array for unknown modality', () => {
      const templates = noteTemplateService.listTemplates('medication-management' as NoteModality)
