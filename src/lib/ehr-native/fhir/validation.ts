...
import { appointmentSchema, scheduleSchema, slotSchema } from '../types/scheduling.js';
import {
  claimSchema,
  claimResponseSchema,
  coverageSchema,
...
import { SUPPORTED_RESOURCE_TYPES, RESOURCE_TABLE_MAP, RESOURCE_PK_MAP, DEDICATED_TABLE_RESOURCES } from './types.js';

/** Zod schema registry for each FHIR resource type. */
export const SCHEMA_REGISTRY: Record<FHIRResourceType, z.ZodType<Record<string, unknown>>> = {
  ...
  AllergyIntolerance: allergyIntoleranceSchema as z.ZodType<Record<string, unknown>>,
  MedicationRequest: medicationRequestSchema as z.ZodType<Record<string, unknown>>,
  ...
  DiagnosticReport: diagnosticReportSchema as z.ZodType<Record<string, unknown>>,
  ...
  ExplanationOfBenefit: explanationOfBenefitSchema as z.ZodType<Record<string, unknown>>,
  DocumentReference: documentReferenceSchema as z.ZodType<Record<string, unknown>>,
  Communication: communicationSchema as z.ZodType<Record<string, unknown>>,
  CommunicationRequest: communicationRequestSchema as z.ZodType<Record<string, unknown>>,
...
export const RESOURCE_REGISTRY: Record<FHIRResourceType, ResourceRegistryEntry> = (() => {
...
export function getRegistryEntry(resourceType: FHIRResourceType): ResourceRegistryEntry {
