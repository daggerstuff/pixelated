...
type RestInteraction = 'read' | 'search-type' | 'create' | 'update' | 'delete' | 'history-instance';
...
const COMMON_SEARCH_PARAMS = [
  ...
  { name: '_count', type: 'number', documentation: 'Number of resources to return per page' },
  { name: '_offset', type: 'number', documentation: 'Starting offset for pagination' },
  { name: '_format', type: 'token', documentation: 'Response format (json)' },
];

/** Resource-specific search parameters. */
const RESOURCE_SEARCH_PARAMS: Partial<Record<FHIRResourceType, Array<{ name: string; type: string; documentation: string }>>> = {
  Patient: [
    { name: 'name', type: 'string', documentation: 'A portion of the name of the patient' },
    ...
    { name: 'identifier', type: 'token', documentation: 'A patient identifier (e.g. MRN)' },
  ...
  Practitioner: [
    ...
    { name: 'identifier', type: 'token', documentation: 'A practitioner identifier (e.g. NPI)' },
  ...
  Encounter: [
    ...
    { name: 'practitioner', type: 'reference', documentation: 'The practitioner present at the encounter' },
    { name: 'status', type: 'token', documentation: 'The status of the encounter' },
    { name: 'class', type: 'token', documentation: 'The class of the encounter' },
  ...
  Observation: [
    ...
    { name: 'encounter', type: 'reference', documentation: 'The encounter associated with the observation' },
    ...
    { name: 'date', type: 'date', documentation: 'The date/time of the observation' },
  ],
  Condition: [
    { name: 'patient', type: 'reference', documentation: 'The subject of the condition' },
  ...
  AllergyIntolerance: [
    { name: 'patient', type: 'reference', documentation: 'The subject of the allergy' },
    { name: 'code', type: 'token', documentation: 'The substance/code of the allergy' },
    { name: 'clinical-status', type: 'token', documentation: 'The clinical status of the allergy' },
  ],
  MedicationRequest: [
    { name: 'patient', type: 'reference', documentation: 'The subject of the medication request' },
    { name: 'code', type: 'token', documentation: 'The medication code' },
    { name: 'status', type: 'token', documentation: 'The status of the request' },
  ],
  Medication: [
    { name: 'code', type: 'token', documentation: 'The medication code' },
  ...
  Immunization: [
    { name: 'patient', type: 'reference', documentation: 'The patient who received the immunization' },
    { name: 'code', type: 'token', documentation: 'The vaccine code' },
    { name: 'status', type: 'token', documentation: 'The immunization status' },
  ],
  Procedure: [
    { name: 'patient', type: 'reference', documentation: 'The subject of the procedure' },
  ...
  Appointment: [
    { name: 'patient', type: 'reference', documentation: 'The patient of the appointment' },
    { name: 'practitioner', type: 'reference', documentation: 'The practitioner of the appointment' },
    { name: 'status', type: 'token', documentation: 'The appointment status' },
    { name: 'date', type: 'date', documentation: 'The appointment date' },
  ],
  Schedule: [
    { name: 'actor', type: 'reference', documentation: 'The actor of the schedule' },
    { name: 'status', type: 'token', documentation: 'The schedule status' },
  ],
  Slot: [
    { name: 'schedule', type: 'reference', documentation: 'The schedule for the slot' },
    { name: 'status', type: 'token', documentation: 'The slot status' },
    { name: 'start', type: 'date', documentation: 'The slot start date/time' },
  ],
  Claim: [
    { name: 'patient', type: 'reference', documentation: 'The patient of the claim' },
    { name: 'status', type: 'token', documentation: 'The claim status' },
    { name: 'use', type: 'token', documentation: 'The claim use' },
  ],
  ClaimResponse: [
    { name: 'patient', type: 'reference', documentation: 'The patient of the claim response' },
    { name: 'status', type: 'token', documentation: 'The claim response status' },
  ],
  Coverage: [
    { name: 'patient', type: 'reference', documentation: 'The patient covered by the coverage' },
  ...
  DocumentReference: [
    { name: 'patient', type: 'reference', documentation: 'The subject of the document' },
    { name: 'type', type: 'token', documentation: 'The document type' },
    { name: 'status', type: 'token', documentation: 'The document reference status' },
  ],
  Communication: [
    { name: 'patient', type: 'reference', documentation: 'The subject of the communication' },
    { name: 'status', type: 'token', documentation: 'The communication status' },
  ],
  CommunicationRequest: [
    { name: 'patient', type: 'reference', documentation: 'The subject of the communication request' },
    { name: 'status', type: 'token', documentation: 'The communication request status' },
  ],
  Consent: [
    { name: 'patient', type: 'reference', documentation: 'The patient of the consent' },
    { name: 'status', type: 'token', documentation: 'The consent status' },
    { name: 'scope', type: 'token', documentation: 'The consent scope' },
  ],
  ServiceRequest: [
    { name: 'patient', type: 'reference', documentation: 'The subject of the service request' },
    { name: 'code', type: 'token', documentation: 'The service code' },
    { name: 'status', type: 'token', documentation: 'The service request status' },
  ],
};

/** All interactions supported by this server. */
const ALL_INTERACTIONS: RestInteraction[] = ['read', 'search-type', 'create', 'update', 'delete', 'history-instance'];
...
export function generateCapabilityStatement(baseUrl: string): Record<string, unknown> {
  ...
  return {
    ...
    rest: [
      {
        mode: 'server',
        documentation: 'Pixelated Empathy FHIR R4 internal server with tenant-aware RLS, consent-gated access, and audit logging.',
        security: {
          cors: false,
          service: [
            {
