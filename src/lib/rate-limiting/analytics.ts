...
import type { RateLimitAnalytics, RateLimitAlert, RateLimitMonitor, RateLimitRule } from "./types";
...
export class RateLimitAnalyticsService {
  ...
  private isRateLimitAlert(value: unknown): value is RateLimitAlert {
    ...
    return (
      ...
      ["attack_detected", "ddos_detected", "rate_limit_exceeded", "system_error"].includes(
        candidate.type,
      ) &&
