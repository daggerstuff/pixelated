...
export type GetAnonymizedMetricsQuery = { __typename: 'Query', anonymizedMetrics: { __typename: 'AnonymizedMetrics', aggregateEmotionScores: Record<string, unknown>, techniqueEffectiveness: Record<string, unknown>, demographicBreakdown: Record<string, unknown>, temporalTrends: Record<string, unknown>, privacyMetrics: { __typename: 'PrivacyMetrics', kAnonymity: number, differentialPrivacyEpsilon: number, reidentificationRisk: number } } | null };
...
export type GetEmotionsQuery = { __typename: 'Query', emotions: Array<{ __typename: 'EmotionAnalysis', id: string, sessionId: string, timestamp: string, confidence: number, emotions: { __typename: 'EmotionVector', joy: number, sadness: number, anger: number, fear: number, surprise: number, disgust: number, trust: number, anticipation: number }, dimensions: { __typename: 'EmotionDimensions', valence: number, arousal: number, dominance: number }, metadata: { __typename: 'EmotionMetadata', source: EmotionSource, processingTime: number, modelVersion: string, confidence: { __typename: 'EmotionConfidence', overall: number } } | null }> };
...
export type GetInterventionsQuery = { __typename: 'Query', interventions: Array<{ __typename: 'InterventionRecord', id: string, userId: string, conversation: string, intervention: string, userResponse: string, effectiveness: number, insights: string, recommendedFollowUp: string | null, modelId: string, modelProvider: string, createdAt: string, updatedAt: string }> };
...
export type GetSessionQuery = { __typename: 'Query', session: { __typename: 'Session', id: string, clientId: string, therapistId: string | null, startTime: string, endTime: string, sessionType: SessionType | null, status: SessionStatus | null, notes: string | null, transcript: string | null, aiAnalysis: { __typename: 'SessionAIAnalysis', emotionalState: Array<string>, techniques: Array<string>, recommendations: Array<string>, riskAssessment: RiskAssessment } | null } | null };
...
export type ListSessionsQuery = { __typename: 'Query', sessions: Array<{ __typename: 'Session', id: string, clientId: string, therapistId: string | null, startTime: string, endTime: string, sessionType: SessionType | null, status: SessionStatus | null, notes: string | null }> };
...
export type GetSessionEmotionsQuery = { __typename: 'Query', session: { __typename: 'Session', id: string, emotions: Array<{ __typename: 'EmotionAnalysis', id: string, sessionId: string, timestamp: string, confidence: number, emotions: { __typename: 'EmotionVector', joy: number, sadness: number, anger: number, fear: number, surprise: number, disgust: number, trust: number, anticipation: number }, dimensions: { __typename: 'EmotionDimensions', valence: number, arousal: number, dominance: number } }> } | null };
...
export type GetSessionTurnsQuery = { __typename: 'Query', session: { __typename: 'Session', id: string, turns: Array<{ __typename: 'ConversationTurn', id: string, role: ConversationRole, content: string, timestamp: string }> } | null };
...
export type SessionUpdatedSubscription = { __typename: 'Subscription', sessionUpdated: { __typename: 'Session', id: string, clientId: string, therapistId: string | null, startTime: string, endTime: string, sessionType: SessionType | null, status: SessionStatus | null } };
...
export type EmotionAnalysisCreatedSubscription = { __typename: 'Subscription', emotionAnalysisCreated: { __typename: 'EmotionAnalysis', id: string, sessionId: string, timestamp: string, confidence: number, emotions: { __typename: 'EmotionVector', joy: number, sadness: number, anger: number, fear: number, surprise: number, disgust: number, trust: number, anticipation: number }, dimensions: { __typename: 'EmotionDimensions', valence: number, arousal: number, dominance: number } } };
...
export type ConversationTurnAddedSubscription = { __typename: 'Subscription', conversationTurnAdded: { __typename: 'ConversationTurn', id: string, role: ConversationRole, content: string, timestamp: string } };
