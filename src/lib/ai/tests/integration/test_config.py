...
BIAS_DETECTION_TEST_CONFIG = {
    ...
    "performance": {"batch_size": 32, "max_workers": 8, "cache_ttl": 3600, "processing_timeout": 30.0},
...
PERFORMANCE_TEST_CONFIG = {
    "load_test": {"concurrent_users": 100, "requests_per_user": 10, "max_response_time": 2.0, "success_rate": 0.95},
    "stress_test": {"max_load": 1000, "duration_minutes": 10, "memory_limit_mb": 512, "cpu_limit_percent": 80},
    "endurance_test": {
        "duration_hours": 24,
        "steady_load": 50,
...
TEST_VALIDATION_CRITERIA = {
    ...
    "integration_tests": {"pass_rate": 0.90, "external_dependency_mock_rate": 0.80, "data_consistency_checks": True},
    "performance_tests": {
