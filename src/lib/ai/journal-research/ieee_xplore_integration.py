...
from research_pipeline import ResearchMetadata, ResearchPaper, SearchCriteria
...
class IEEEXploreClient:
    ...
    async def get_paper_metadata(self, paper_id: str) -> IEEEPaper | None:
    ...
    def _parse_paper_metadata(self, response: dict[str, Any]) -> IEEEPaper | None:
...
class IEEEResearchPipeline:
    ...
    def _convert_to_research_paper(self, ieee_paper: IEEEPaper) -> ResearchPaper | None:
...
ieee_client: IEEEXploreClient | None = None
ieee_pipeline: IEEEResearchPipeline | None = None


async def initialize_ieee_client(config: IEEESearchConfig | None = None) -> IEEEXploreClient:
...
async def get_ieee_paper_metadata(paper_id: str) -> IEEEPaper | None:
