...
export class PatientResponseService {
  ...
  private analyzeTherapistUtterance(
    ...
    if (
      ...
      logger.info("[InterventionDetection] Detected: Reflection", {
        utterance,
      });
    }
  ...
  private analyzePatientUtterance(
    ...
    if (
      ...
      rapportChange +=
        ALLIANCE_ADJUSTMENTS.PATIENT_DISAGREEMENT_RAPPORT_PENALTY;
  ...
  public updateTherapeuticAllianceMetrics(
    ...
    const therapistAnalysis =
      this.analyzeTherapistUtterance(therapistUtterance);
