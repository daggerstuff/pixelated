...
export class AdvancedPatternAnalysisService {
  ...
  private neuralNetworkModels: Map<string, NeuralNetworkEnhancement> =
    new Map();
  ...
  private patternEvolutionModels: Map<string, PatternEvolutionModel> =
    new Map();
  ...
  private async calculateTechniqueCorrelation(
    ...
    const effectSizeCohen = this.calculateCohenD(
      effectiveness1,
      effectiveness2,
    );
