...
describe('useIntegration hooks', () => {
  ...
  beforeEach(() => {
    ...
    vi.mocked(useIntegrationStore).mockImplementation(((
      selector?: (state: typeof storeState) => unknown,
    ) =>
      typeof selector === 'function'
        ? selector(storeState)
        : storeState) as any)
    ;(useIntegrationStore as any).getState = () => storeState
  })
  ...
  describe('useIntegrationPlanListQuery', () => {
    ...
    it('applies filters from store', async () => {
      ...
      ;(useIntegrationStore as any).getState = () => filteredStoreState
  ...
  describe('useIntegrationInitiateMutation', () => {
    it('initiates integration successfully', async () => {
      ...
      ;(useIntegrationStore as any).getState = () => ({
        setSelectedPlanId,
      })
  ...
  describe('useIntegrationSelection', () => {
    it('returns selection state from store', () => {
      ...
      vi.mocked(useIntegrationStore).mockReturnValue(mockState)
