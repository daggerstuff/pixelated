...
import { useProgressQuery, useProgressMetricsQuery, useInvalidateProgress } from "../useProgress";
...
describe("useProgress hooks", () => {
  ...
  describe("useProgressQuery", () => {
    ...
    it("respects enabled option", () => {
      const { result } = renderHook(() => useProgressQuery("session-1", { enabled: false }), {
        wrapper: createWrapper(),
      });
  ...
  describe("useProgressMetricsQuery", () => {
    it("fetches progress metrics successfully", async () => {
      ...
      const { result } = renderHook(() => useProgressMetricsQuery("session-1"), {
        wrapper: createWrapper(),
      });
