...
class TestComparativeProgressService extends ComparativeProgressService {
  ...
  override async fetchBenchmarkData(_params: ComparativeProgressParams): Promise<Benchmark | null> {
...
describe("ComparativeProgressService", () => {
  ...
  it("should handle service errors gracefully", async () => {
    ...
    vi.spyOn(service as any, "fetchUserProgressData").mockRejectedValue(
