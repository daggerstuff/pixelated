...
export class ComparativeProgressService {
   ...
   */
  protected async fetchUserProgressData(
    params: ComparativeProgressParams,
   ...
   */
  protected async fetchBenchmarkData(params: ComparativeProgressParams): Promise<Benchmark | null> {
    // NOTE: This is mock data for development purposes.
  ...
  private generateInsights(
    ...
    const lowerIsBetter =
      benchmark.metricName.includes("phq") || benchmark.metricName.includes("gad");
