  ...
  const store: FHEState = {
    ...
    initializeFHE: async (options: EncryptionOptions) => {
      try {
        ...
        set({
          ...
          securityLevel: typeof options.securityLevel === "number" ? options.securityLevel : 192,
          keyId,
          performanceMetrics: {
    ...
    decrypt: async (encryptedMessage: string) => {
      ...
      try {
        ...
        const encryptedData =
          typeof encryptedMessage === "string" && encryptedMessage.startsWith("{")
        ...
        // Perform decryption
        const decrypted = await fheService.decrypt(encryptedData as EncryptedData);
        ...
        if ("processEncrypted" in fheService && fheService.processEncrypted) {
          ...
          switch (operation) {
            ...
            case FHEOperation.DotProduct: {
              throw new Error("Not implemented yet: FHEOperation.DotProduct case");
            }
            case FHEOperation.Subtraction: {
              throw new Error("Not implemented yet: FHEOperation.Subtraction case");
            }
            ...
            case FHEOperation.Polynomial: {
              throw new Error("Not implemented yet: FHEOperation.Polynomial case");
            }
            case FHEOperation.Rescale: {
              throw new Error("Not implemented yet: FHEOperation.Rescale case");
            }
            case FHEOperation.SENTIMENT: {
              throw new Error("Not implemented yet: FHEOperation.SENTIMENT case");
            }
            case FHEOperation.CATEGORIZE: {
              throw new Error("Not implemented yet: FHEOperation.CATEGORIZE case");
            }
            case FHEOperation.SUMMARIZE: {
              throw new Error("Not implemented yet: FHEOperation.SUMMARIZE case");
            }
            ...
            case FHEOperation.WORD_COUNT: {
              throw new Error("Not implemented yet: FHEOperation.WORD_COUNT case");
            }
            case FHEOperation.CHARACTER_COUNT: {
              throw new Error("Not implemented yet: FHEOperation.CHARACTER_COUNT case");
            }
            case FHEOperation.KEYWORD_DENSITY: {
              throw new Error("Not implemented yet: FHEOperation.KEYWORD_DENSITY case");
            }
            case FHEOperation.READING_LEVEL: {
              throw new Error("Not implemented yet: FHEOperation.READING_LEVEL case");
            }
            case FHEOperation.EMOTION_CLASSIFY: {
              throw new Error("Not implemented yet: FHEOperation.EMOTION_CLASSIFY case");
            }
