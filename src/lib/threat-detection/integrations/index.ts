...
export * from "./utils";
export { createThreatDetectionService, type ThreatDetectionConfig, ThreatDetectionService };
...
export function createThreatDetectionIntegration(
  ...
  return {
    ...
    analyzeThreat: async (threatData: unknown) =>
      threatDetectionService.analyzeThreat(
        threatData as Parameters<typeof threatDetectionService.analyzeThreat>[0],
      ),
