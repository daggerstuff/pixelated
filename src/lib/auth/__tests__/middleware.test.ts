...
describe("Authentication Middleware", () => {
  ...
  describe("Integration with Phase 6 MCP Server", () => {
    ...
    it("should track rate limiting events", async () => {
      ...
      expect(updatePhase6AuthenticationProgress).toHaveBeenCalledWith(null, "rate_limit_exceeded");
    });
    ...
    it("should track CSRF violations", async () => {
      ...
      expect(updatePhase6AuthenticationProgress).toHaveBeenCalledWith(null, "csrf_violation");
    });
  });
});
