...
export const SCOPES: Record<string, ScopeDefinition> = {
  ...
  "memory:read": {
    ...
    routes: ["GET /api/memory/*", "GET /api/v1/memory/*", "GET /api/v1/developer/memory/*"],
  },
  "memory:write": {
    name: "memory:write",
    ...
    routes: [
      ...
      "POST /api/v1/developer/memory/*",
      "PATCH /api/v1/developer/memory/*",
      "DELETE /api/v1/developer/memory/*",
    ],
  },
  "developer:manage": {
