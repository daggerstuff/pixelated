...
export interface TEEOptions {
  provider: "aws-nitro" | "azure-confidential-computing" | "gcp-confidential-vm" | "intel-sgx";
...
export function isEncryptedData(obj: unknown): obj is EncryptedData {
  ...
  return typeof id === "string" && typeof dataType === "string" && data !== undefined;
}
...
export interface FHEService {
   ...
   */
  applyPolynomial?(value: EncryptedData, coefficients: Polynomial): Promise<EncryptedData>;
   ...
   */
  decryptBatch<T>(ciphertexts: EncryptedData<T>[]): Promise<T[]>;
