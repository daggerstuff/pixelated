...
describe('PiiRedactor', () => {
  ...
  it('evaluate returns escalate for multiple PII', () => {
    const text = 'Email: a@b.com, phone: 555-111-2222, email: c@d.com, phone: 555-333-4444';
    const evaluation = redactor.evaluate(text);
...
describe('TraumaFilter', () => {
  ...
  it('registers user-specific triggers', () => {
    ...
    const result = traumaFilter.filter('The thunderstorms triggered my anxiety.', 'user-1');
