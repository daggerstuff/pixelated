...
function extractEmotions(text: string): {
  ...
  const emotionMap: Record<string, { keywords: string[]; valence: number; arousal: number }> = {
    anxiety: {
      keywords: ["anxious", "anxiety", "worry", "worried", "panic", "nervous", "fear", "afraid"],
      valence: -0.5,
      arousal: 0.7,
    },
    sadness: {
      keywords: ["sad", "grief", "loss", "depressed", "depression", "hopeless", "lonely", "empty"],
      valence: -0.7,
      arousal: -0.3,
    },
    joy: {
      keywords: ["happy", "joy", "excited", "hopeful", "grateful", "good", "great", "wonderful"],
      valence: 0.7,
      arousal: 0.5,
    },
    anger: {
    ...
    fear: {
      keywords: ["scared", "terrified", "frightened", "threat", "danger", "unsafe"],
      valence: -0.7,
      arousal: 0.6,
    },
    guilt: {
    ...
    shame: {
      keywords: ["ashamed", "embarrassed", "humiliated", "worthless", "pathetic"],
      valence: -0.8,
      arousal: 0.4,
    },
    despair: {
    ...
    hope: {
      keywords: ["hope", "maybe", "someday", "things will get better", "looking forward"],
      valence: 0.6,
      arousal: 0.3,
    },
    confusion: {
  ...
  const negationPattern = /\b(not|no|never|don't|doesn't|didn't|isn't|aren't|wasn't|weren't)\b/;
