...
describe("v1 public memory API Zod contract validation (PIX-3904)", () => {
  ...
  beforeEach(() => {
    ...
    (getProductMemoryGateway as unknown as ReturnType<typeof vi.fn>).mockReturnValue(gateway);
  });
  ...
  describe("GET /api/v1/memory (list)", () => {
    it("validates response against ListMemoriesResponse schema", async () => {
      ...
      expect(
        result.success,
        `ListMemoriesResponse validation failed: ${JSON.stringify(result.success === false ? result.error.issues : "unknown error")}`,
      ).toBe(true);
    });
    ...
    it("validates empty list response", async () => {
      ...
      expect(
        result.success,
        `ListMemoriesResponse (empty) validation failed: ${JSON.stringify(result.success === false ? result.error.issues : "unknown error")}`,
      ).toBe(true);
    });
  });
  ...
  describe("POST /api/v1/memory (create)", () => {
    it("validates response against CreateMemoryResponse schema", async () => {
      ...
      expect(
        result.success,
        `CreateMemoryResponse validation failed: ${JSON.stringify(result.success === false ? result.error.issues : "unknown error")}`,
      ).toBe(true);
    });
    ...
    it("validates response with all optional fields", async () => {
      ...
      expect(
        result.success,
        `CreateMemoryResponse (all fields) validation failed: ${JSON.stringify(result.success === false ? result.error.issues : "unknown error")}`,
      ).toBe(true);
    });
  });
  ...
  describe("GET /api/v1/memory/:memoryId (get by ID)", () => {
    it("validates response against GetMemoryResponse schema", async () => {
      ...
      expect(
        result.success,
        `GetMemoryResponse validation failed: ${JSON.stringify(result.success === false ? result.error.issues : "unknown error")}`,
      ).toBe(true);
    });
  });
  ...
  describe("PATCH /api/v1/memory/:memoryId (update)", () => {
    it("validates response against UpdateMemoryResponse schema", async () => {
      ...
      expect(
        result.success,
        `UpdateMemoryResponse validation failed: ${JSON.stringify(result.success === false ? result.error.issues : "unknown error")}`,
      ).toBe(true);
    });
  });
  ...
  describe("DELETE /api/v1/memory/:memoryId (delete)", () => {
    it("validates response against DeleteMemoryResponse schema", async () => {
      ...
      expect(
        result.success,
        `DeleteMemoryResponse validation failed: ${JSON.stringify(result.success === false ? result.error.issues : "unknown error")}`,
      ).toBe(true);
    });
  });
  ...
  describe("GET /api/v1/memory/search (search via query)", () => {
    it("validates response against SearchMemoriesResponse schema", async () => {
      ...
      expect(
        result.success,
        `SearchMemoriesResponse (GET) validation failed: ${JSON.stringify(result.success === false ? result.error.issues : "unknown error")}`,
      ).toBe(true);
    });
    ...
    it("validates empty search results", async () => {
      ...
      const response = await searchGet({
        request: makeRequest("http://localhost/api/v1/memory/search?q=nonexistent"),
      });
      ...
      expect(
        result.success,
        `SearchMemoriesResponse (empty) validation failed: ${JSON.stringify(result.success === false ? result.error.issues : "unknown error")}`,
      ).toBe(true);
    });
  });
  ...
  describe("POST /api/v1/memory/search (search via body)", () => {
    it("validates response against SearchMemoriesResponse schema", async () => {
      ...
      expect(
        result.success,
        `SearchMemoriesResponse (POST) validation failed: ${JSON.stringify(result.success === false ? result.error.issues : "unknown error")}`,
      ).toBe(true);
    });
  });
  ...
  describe("Error responses validate against MemoryApiError schema", () => {
    it("401 unauthorized error", async () => {
      ...
      expect(
        result.success,
        `MemoryApiError (401) validation failed: ${JSON.stringify(result.success === false ? result.error.issues : "unknown error")}`,
      ).toBe(true);
    });
    ...
    it("404 not found error", async () => {
      ...
      expect(
        result.success,
        `MemoryApiError (404) validation failed: ${JSON.stringify(result.success === false ? result.error.issues : "unknown error")}`,
      ).toBe(true);
    });
    ...
    it("400 validation error", async () => {
      ...
      expect(
        result.success,
        `MemoryApiError (400) validation failed: ${JSON.stringify(result.success === false ? result.error.issues : "unknown error")}`,
      ).toBe(true);
    });
    ...
    it("502 upstream_unavailable error", async () => {
      ...
      expect(
        result.success,
        `MemoryApiError (502) validation failed: ${JSON.stringify(result.success === false ? result.error.issues : "unknown error")}`,
      ).toBe(true);
    });
    ...
    it("403 forbidden error", async () => {
      ...
      expect(
        result.success,
        `MemoryApiError (403) validation failed: ${JSON.stringify(result.success === false ? result.error.issues : "unknown error")}`,
      ).toBe(true);
    });
  });
