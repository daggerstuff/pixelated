...
export const reprioritizationApiLogger = createBuildSafeLogger("reprioritization-api");
...
>(
  action: string,
  handler: (context: TContext, user: AuthenticatedReprioritizationUser) => Promise<Response>,
) {
...
export function handleReprioritizationApiError(action: string, error: unknown): Response {
