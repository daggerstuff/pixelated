...
describe("path-security utilities", () => {
  ...
  describe("validatePath", () => {
    ...
    it("should throw on directory traversal", () => {
      expect(() => validatePath("../traversal.txt", allowedDir))
        .toThrow("Directory traversal sequences (..) are not allowed");
    });
    ...
    it("should throw on path escaping base directory", () => {
      ...
      expect(() => validatePath("/absolute/path", allowedDir))
        .toThrow("Absolute paths are not allowed");
    });

    it("should throw on unsafe characters", () => {
      expect(() => validatePath("file<>.txt", allowedDir))
  ...
  describe("safeJoin", () => {
    ...
    it("should throw if any segment is unsafe", () => {
      expect(() => safeJoin(allowedDir, "subdir", "..", "secret"))
        .toThrow();
    });
  });
  ...
  describe("sanitizeFilename", () => {
    it("should remove dangerous characters", () => {
      ...
      expect(sanitizeFilename("unsafe/path\\char<>:\"|?*.ext"))
        .toBe("unsafepathchar.ext");
    });
  ...
  describe("validatePathAgainstMultiple", () => {
    ...
    it("should throw if it matches none", () => {
      const dirs = ["/a", "/b"];
      expect(() => validatePathAgainstMultiple("../../outside", dirs))
        .toThrow();
    });
  });
});
