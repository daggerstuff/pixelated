...
describe('SyncManager', () => {
  ...
  describe('attemptSync', () => {
    ...
    it('should reset backoff on successful sync', async () => {
      ...
      vi.spyOn(indexedDBRequestQueue, 'processQueue').mockResolvedValue(
        undefined,
      )
      // Mock hasPendingRequests to return false (queue empty)
      vi.spyOn(indexedDBRequestQueue, 'hasPendingRequests').mockReturnValue(
        false,
      )
    ...
    it('should increase backoff on failed sync', async () => {
      ...
      vi.spyOn(indexedDBRequestQueue, 'processQueue').mockRejectedValue(
