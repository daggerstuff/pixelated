...
if (!skipTests) {
  test.describe('Cross-Browser Compatibility', () => {
    test('should test browser features and compatibility', async ({ page }) => {
      ...
      console.log(
        '✅ Browser feature compatibility test COMPLETED successfully!',
      )
    })
    ...
    test('should work correctly across browsers', async ({
      ...
      const desktopNavHidden = await page
        .locator('nav.marketing-nav__links')
        .isHidden()
      ...
      const hamburgerVisibleMobile = await page
        .locator('#mobile-menu-button')
        .isVisible()
