...
export function TherapyGate({ className, gateApiUrl }: TherapyGateProps) {
  ...
  const handleSubmit = useCallback(async () => {
    console.log('[TherapyGate] handleSubmit called!')
    ...
    console.log('[TherapyGate] textarea:', !!textarea, 'helper:', !!helper)
    if (!textarea) {
      console.log('[TherapyGate] Missing textarea')
    ...
    if (isSubmittingRef.current) {
      console.log('[TherapyGate] Already submitting, returning')
      if (form) form.setAttribute('data-submit-error', 'empty-or-submitting')
      return
    }
  ...
  if (typeof window !== 'undefined') {
    ;(window as any).handleTherapyGateSubmit = () => handleSubmitRef.current()
    ;(window as any).pixelatedSubmit = () => handleSubmitRef.current()
  }
