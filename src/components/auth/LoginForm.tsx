...
export function LoginForm({
  ...
  const renderResetSuccess = () => (
    <div className="space-y-4 text-center">
      <h2 className="text-gradient text-responsive--heading">Password Reset Email Sent</h2>
  ...
  const renderMainForm = () => (
    <div className="auth-form-container form-container responsive-auth-container text-center">
      {mode === "reset" && (
        <h2 className="text-gradient text-responsive--heading" data-testid="reset-password-heading">
          Reset Password
        </h2>
      )}
      {mode === "login" && <h2 className="text-gradient text-responsive--heading">Sign In</h2>}
      ...
      >
        ...
        <button type="submit" className="btn btn-primary btn-responsive" disabled={isLoading}>
          {isLoading ? (
  ...
  const renderRememberMe = () => (
    <div className="form-group remember-me form-group-responsive">
      <label htmlFor="rememberMeCheckbox" className="checkbox-container touch-target">
        <input
        ...
        <span className="checkbox-label text-responsive--small">Remember me</span>
      </label>
    </div>
  );
