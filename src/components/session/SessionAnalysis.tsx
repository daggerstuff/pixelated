...
export default function SessionAnalysis({ sessionId, clientId }: SessionAnalysisProps) {
  ...
  useEffect(() => {
    const fetchSessionEmotionData = async () => {
      ...
      try {
        ...
        const url = new URL("/api/emotions/session-analysis", window.location.origin);
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div className="bg-white rounded-lg p-4 shadow-sm">
          ...
          <EmotionTrackingChart data={emotionData} isLoading={isLoading} height={300} />

          <p className="text-gray-500 mt-4 text-sm">
            This chart shows the client&apos;s emotional dimensions throughout the session, helping
            identify patterns and significant shifts.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg p-4 shadow-sm">
          ...
          {isLoading ? (
            ...
            <div className="space-y-4">
              <div className="border-neutral-400 bg-neutral-100 border-l-4 p-3">
                <h4 className="font-medium">Emotional Patterns</h4>
                <p className="text-sm text-neutral-700">
                  Client shows cyclical patterns of emotional arousal, possibly indicating anxiety
              ...
              <div className="border-neutral-400 bg-neutral-100 border-l-4 p-3">
                ...
                <p className="text-sm text-neutral-700">
                  Increased emotional regulation compared to previous sessions, with improved
