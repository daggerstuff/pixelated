      ...
      <FocusTrap active={isOpen}>
        ...
        >
          ...
          <div className='border-b p-4'>
            <h2 id='consent-dialog-title' className='text-gray-800 text-xl font-semibold'>
              Privacy & Data Collection Consent
            </h2>
          </div>

          {/* Content */}
          <div id='consent-dialog-description' className='max-h-[70vh] overflow-y-auto p-4'>
            <div className='mb-6'>
              <svg
              ...
              <p className='text-gray-700 text-center font-medium'>Your privacy is our priority</p>
            </div>

            <div className='mb-6'>
              <h3 className='text-gray-800 mb-2 font-medium'>About This Simulator</h3>
              <p className='text-gray-600 mb-4 text-sm'>
                This therapeutic practice simulator is designed to help you improve your skills in a
                completely private environment. We take privacy and security seriously, especially
                when it comes to healthcare interactions.
              </p>

              <div className='mb-4'>
                <h4 className='text-blue-800 mb-2 font-medium'>What we DO NOT collect or store:</h4>
              ...
              <div className='mb-4'>
                <h4 className='text-blue-800 mb-2 font-medium'>What you can optionally allow:</h4>
                <ul className='text-gray-600 list-disc space-y-1 pl-5 text-sm'>
            ...
            <div className='bg-gray-50 border-gray-200 rounded-md border p-4'>
              <div className='mb-4 flex items-start'>
                ...
                <label htmlFor='consent-checkbox' className='text-gray-700 ml-2 text-sm'>
                  {consentText}
                </label>
              </div>
              <p className='text-gray-500 text-xs'>
                You can change your preference at any time from the metrics panel. You can always
                use the simulator without enabling metrics collection.
              </p>
            </div>
          </div>
