...
import type { BiasAnalysisResults, SessionData } from "../../../lib/types/bias-detection";
...
export const BiasAnalysisDisplay: FC<BiasAnalysisDisplayProps> = ({ results, sessionData }) => {
    ...
    <div className="bias-analysis-display space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <div className="bg-neutral-50 rounded-lg p-6">
          <h3 className="text-neutral-900 mb-4 text-lg font-semibold">Overall Bias Score</h3>
          <div className="flex items-center justify-between">
            <div className={`text-4xl font-bold ${getScoreColor(results.overallBiasScore)}`}>
        ...
        {/* Alert Level */}
        <div className="bg-neutral-50 rounded-lg p-6">
          <h3 className="text-neutral-900 mb-4 text-lg font-semibold">Alert Level</h3>
          <div
          ...
          {sessionData && (
            <div className="text-neutral-600 mt-4 text-sm">
              ...
              {sessionData.scenario && <div>Scenario: {sessionData.scenario}</div>}
            </div>
          )}
        </div>
      </div>
      ...
      <div className="bg-white border-neutral-200 rounded-lg border p-6">
        <h3 className="text-neutral-900 mb-6 text-lg font-semibold">Multi-Layer Bias Analysis</h3>

        <div className="space-y-6">
          {/* Preprocessing Layer */}
          <div className="bg-neutral-50 border border-neutral-200 rounded-md p-4">
            <h4 className="text-neutral-900 mb-3 font-semibold">Preprocessing Layer</h4>
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
              <div className="text-center">
                ...
                >
                  {formatScore(results.layerResults.preprocessing.linguisticBias.genderBiasScore)}
                </div>
              ...
              <div className="text-center">
                ...
                >
                  {formatScore(results.layerResults.preprocessing.linguisticBias.racialBiasScore)}
                </div>
              ...
              <div className="text-center">
                ...
                >
                  {formatScore(results.layerResults.preprocessing.linguisticBias.ageBiasScore)}
                </div>
                <div className="bg-neutral-50 border border-neutral-200 rounded-md p-4">
                  Age Bias
                </div>
              ...
              <div className="text-center">
                ...
                >
                  {formatScore(results.layerResults.preprocessing.linguisticBias.culturalBiasScore)}
                </div>
            ...
            <div className="bg-neutral-50 mt-4 rounded-lg p-3">
              <div className="flex items-center justify-between">
                <span className="text-neutral-900 text-sm font-medium">Diversity Index</span>
              ...
              {results.layerResults.preprocessing.representationAnalysis.underrepresentedGroups
                .length > 0 && (
          ...
          <div className="bg-neutral-50 border border-neutral-200 rounded-md p-4">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              <div className="bg-neutral-100 rounded-lg p-3 text-center">
                ...
                >
                  {formatScore(results.layerResults.modelLevel.fairnessMetrics.demographicParity)}
                </div>
                <div className="text-neutral-600 text-sm">Demographic Parity</div>
              </div>
              <div className="bg-neutral-100 rounded-lg p-3 text-center">
                <div
                  className={`text-xl font-bold ${getScoreColor(1 - results.layerResults.modelLevel.fairnessMetrics.equalizedOdds)}`}
                >
                  {formatScore(results.layerResults.modelLevel.fairnessMetrics.equalizedOdds)}
                </div>
              ...
              <div className="bg-neutral-100 rounded-lg p-3 text-center">
                ...
                >
                  {formatScore(results.layerResults.modelLevel.fairnessMetrics.calibration)}
                </div>
          ...
          {/* Interactive Layer */}
          <div className="bg-neutral-50 border border-neutral-200 rounded-md p-4">
            <h4 className="text-neutral-900 mb-3 font-semibold">Interactive Layer</h4>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              <div className="bg-neutral-100 rounded-lg p-3 text-center">
                <div className="text-neutral-900 text-xl font-bold">
                  {results.layerResults.interactive.counterfactualAnalysis.scenariosAnalyzed}
                </div>
                <div className="text-neutral-600 text-sm">Scenarios Analyzed</div>
              </div>
              <div className="bg-neutral-100 rounded-lg p-3 text-center">
                <div
                  className={`text-xl font-bold ${
                    results.layerResults.interactive.counterfactualAnalysis.biasDetected
                      ? "text-neutral-900"
                      : "text-neutral-600"
                  }`}
                >
          ...
          {/* Evaluation Layer */}
          <div className="bg-neutral-50 border border-neutral-200 rounded-md p-4">
            <h4 className="text-neutral-900 mb-3 font-semibold">Evaluation Layer</h4>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              <div className="bg-neutral-100 rounded-lg p-3 text-center">
                <div
                  className={`text-xl font-bold ${getScoreColor(results.layerResults.evaluation.huggingFaceMetrics.bias)}`}
                >
                  {formatScore(results.layerResults.evaluation.huggingFaceMetrics.bias)}
                </div>
              ...
              <div className="bg-neutral-100 rounded-lg p-3 text-center">
                ...
                >
                  {formatScore(results.layerResults.evaluation.huggingFaceMetrics.stereotype)}
                </div>
      ...
      {results.recommendations.length > 0 && (
        <div className="bg-neutral-100 border-neutral-200 rounded-lg border p-6">
          <h3 className="text-neutral-900 mb-4 text-lg font-semibold">Recommendations</h3>
      ...
      {results.demographics && (
        <div className="bg-neutral-50 border-neutral-200 rounded-lg border p-6">
          <h3 className="text-neutral-900 mb-4 text-lg font-semibold">Demographic Context</h3>
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
            <div>
              <div className="text-neutral-600 text-sm">Age Group</div>
              <div className="text-neutral-900 font-semibold">{results.demographics.age}</div>
            </div>
            <div>
              <div className="text-neutral-600 text-sm">Gender</div>
              <div className="text-neutral-900 font-semibold">{results.demographics.gender}</div>
            </div>
            <div>
              <div className="text-neutral-600 text-sm">Ethnicity</div>
              <div className="text-neutral-900 font-semibold">{results.demographics.ethnicity}</div>
            </div>
            <div>
