...
describe('SidebarReact', () => {
  it('should contain navigation link for clinical validity dashboard', () => {
    ...
    expect(clinicalValidityLink.closest('a')).toHaveAttribute('href', '/dashboard/clinical-validity')
  })
  ...
  it('should contain navigation link for training annotation', () => {
    ...
    expect(annotationLink.closest('a')).toHaveAttribute('href', '/training/annotation')
  })
