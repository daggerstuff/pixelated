...
export default function MentalHealthChatDemoReact({
  ...
  const handleToggleSetting = (setting: keyof typeof settings) => {
    setSettings((prev) => {
      ...
      if (mentalHealthChat && (setting === "enableAnalysis" || setting === "useExpertGuidance")) {
                ...
                <div className="flex justify-start" role="status" aria-live="polite">
                  <div className="bg-muted max-w-[80%] rounded-lg px-4 py-3">
                    <div className="flex h-4 items-center space-x-1.5">
                      <div className="bg-foreground/50 h-2 w-2 animate-typing-dot rounded-full"></div>
                      <div
                        className="bg-foreground/50 h-2 w-2 animate-typing-dot rounded-full"
