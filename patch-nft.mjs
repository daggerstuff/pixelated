...
function findNftJs() {
  ...
  for (const ent of entries) {
    ...
    const nested = resolve(pnpmDir, ent.name, "node_modules/@astrojs/vercel/dist/lib/nft.js");
    try { require.resolve(nested); return nested; } catch {}
  }
  return null;
}

const nftPath = findNftJs() || "/home/vivi/pixelated/node_modules/.pnpm/@astrojs+vercel@10.0.8_@aws-sdk+credential-provider-web-identity@3.972.54_astro@6.4.8_@_41b86d61148770c5370c722eefd24c67/node_modules/@astrojs/vercel/dist/lib/nft.js";
...
const oldSingle = "result = await nodeFileTrace([entryPath], { base: fileURLToPath(base), cache });";
...
if (code.includes(oldChunk)) {
  ...
  console.error("Could not find the nodeFileTrace call to patch. Dumping around it:");
