...
describe('exportReportToCSV', () => {
  ...
  it('exports SOC 2 security report', async () => {
    const report: SOC2SecurityReport = {
      ...
      accessControls: {
        totalUsers: 10,
        roleAssignments: [
          { role: 'physician', count: 5, permissions: ['read_patient'] },
        ],
        permissionGrants: 3,
  ...
  it('exports SOC 2 availability report', async () => {
    const report: SOC2AvailabilityReport = {
      ...
      disasterRecovery: {
        drPlanVersion: '1.0.0',
        lastTestDate: '2025-01-10T10:00:00.000Z',
        rtoMinutes: 60,
        rpoMinutes: 15,
      },
      summary: {
