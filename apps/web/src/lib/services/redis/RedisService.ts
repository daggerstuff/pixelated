...
import { createCommandClient, createMockClient, type RedisClient } from './redis-service.utils'
...
export class RedisService extends EventEmitter implements IRedisService {
  ...
  async connect(): Promise<void> {
    try {
      ...
      const commandClient = createCommandClient(rawClient)
  ...
  private createClient(): RedisClient {
    ...
    return createCommandClient(new Redis(this.config.url, redisOptions))
  }
