  ...
  return (
    <div className="np-fsg">
      <style>{`
        ...
        .np-fsg__group-title {
          font-family: var(--np-font-mono, 'JetBrains Mono Variable', monospace);
        ...
        .np-fsg .np-fsg__label {
          font-family: var(--np-font-mono, 'JetBrains Mono Variable', monospace) !important;
        ...
        <div className="np-fsg__grid">
          ...
          <div className="np-fsg__field">
            ...
            <Input
              ...
              error
              aria-describedby="error-input-msg"
            />
            <p id="error-input-msg" className="np-fsg__error-text">
      ...
      <div className="np-fsg__group">
        ...
        <form className="np-fsg__form-example np-fsg__grid">
          ...
          <div className="np-fsg__form-actions np-fsg__grid--1">
            <Button variant="outline" className="np-fsg__btn-ghost">
              Cancel
            </Button>
