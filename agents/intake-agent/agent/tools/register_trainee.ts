...
const SCHEMA = z.object({
  ...
  email: z
    .string()
    .email()
    .describe('Email address for contact and platform access.'),
  clinical_role: z
    .string()
    .min(1)
  ...
  experience_level: z
    ...
    .describe('Self-reported experience level.'),
  licensing: z
    .object({
      license_number: z
        .string()
      ...
      expiration_date: z
        .string()
        .describe('License expiration date (ISO date string).'),
    })
  ...
  clinical_background: z
    .object({
      ...
      years_of_practice: z
        .number()
        .min(0)
        .describe('Years of clinical practice.'),
      therapeutic_approaches: z
        .array(z.string())
        .describe('Therapeutic modalities trained in.'),
    })
    .describe('Clinical background and training.'),
  specialization: z
    .string()
    .min(1)
    .describe('Primary clinical specialization or focus area.'),
  credentials: z
    .array(z.string())
    .describe('Professional credentials (e.g. LCSW, LMFT, PhD).'),
