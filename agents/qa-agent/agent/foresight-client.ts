 ...
 *
 * The client is not created until the first tool call, keeping the QA agent's
 * startup context small and avoiding an idle SSE connection when the agent is
 * not actively using Foresight.
 */
