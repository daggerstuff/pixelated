...
const SCHEMA = z.object({
  trainee_ids: z.array(z.string().uuid()).min(2).max(10).describe("UUIDs of trainees to compare."),
  dimension: z.string().optional().describe("Filter to a specific rubric dimension."),
});
      ...
      summary: {
        ...
        score_spread:
          comparisons.length >= 2
            ? comparisons[0].total_avg - comparisons[comparisons.length - 1].total_avg
            : 0,
      },
    };
  },
