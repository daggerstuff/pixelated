...
- Verifiability: if you cannot verify a claim because you lack the original or reference material, say CANNOT VERIFY explicitly - never assert correctness you could not check.
- Confidence: score each issue 0-100 (0=false positive; 25=could not verify; 50=real but minor; 75=verified and important; 100=certain).
