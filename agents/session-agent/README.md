...
| Connections (2) | `agent/connections/foresight.ts`, `agent/connections/memory-mcp.ts` — `defineMcpClientConnection` with env-gated URLs                                                                                                                             |
...
| Lib             | `agent/lib/process-shutdown.ts`, `agent/lib/workers-ai.ts`, `agent/lib/workers-ai-mcp-client.ts` (lazy), `agent/foresight-client.ts` (SSEClientTransport → `/sse`)                                                                                |
