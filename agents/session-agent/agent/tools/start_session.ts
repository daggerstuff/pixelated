  ...
  async execute(input) {
    ...
    return {
      ...
      foresight_stub: {
        memory_id: null,
        note:
          "Foresight MCP write is not yet wired in this slice. See agent/connections/foresight.ts.",
      },
      mongo_stub: {
        collection: "sessions",
        document_id: sessionId,
        note:
          "Mongo write is not yet wired in this slice. See agent/connections/memory-mcp.ts.",
      },
    };
  },
});
