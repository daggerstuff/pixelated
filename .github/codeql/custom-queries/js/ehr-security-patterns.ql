...
/**
 * Configuration for insecure EHR credentials leakage.
 */
module EHRLinkConfig implements DataFlow::ConfigSig {
...
/**
 * Configuration for unsafe EHR access via remote data.
 */
...
module EHRLinkFlow = TaintTracking::Global<EHRLinkConfig>;
module UnsafeEHRAccessFlow = TaintTracking::Global<UnsafeEHRAccessConfig>;

from DataFlow::PathNode source, DataFlow::PathNode sink
where
  EHRLinkFlow::hasFlowPath(source, sink) or
