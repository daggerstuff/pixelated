 ...
 * @description Detects potentially insecure FHIR operations without security context in the same function
 * @kind problem
...
select fhirOp,
  "FHIR operation without security context in the same function detected. Ensure proper authorization."
