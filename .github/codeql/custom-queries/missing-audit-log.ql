 ...
 * @description Detects EHR operations without audit logging in the same function
 * @kind problem
...
select ehrOp,
  "EHR operation detected without audit logging in the same function. HIPAA compliance requires comprehensive audit trails."
