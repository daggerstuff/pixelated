 ...
 * @description Detects FHIR operations without version compatibility checks in the same function
 * @kind problem
...
select clientInit,
  "FHIR client initialization without version check in the same function detected. Ensure version compatibility."
