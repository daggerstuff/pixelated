...
/**
 * A configuration for detecting sensitive EHR credentials leaking into logs or configuration.
 */
...
module EHRSecurity = TaintTracking::Global<EHRSecurityConfig>;
import EHRSecurity::PathGraph

from EHRSecurity::PathNode source, EHRSecurity::PathNode sink
where EHRSecurity::hasFlowPath(source, sink)
