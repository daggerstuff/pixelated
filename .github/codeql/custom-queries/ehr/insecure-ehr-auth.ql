...
where
  ...
  not exists(CallExpr mfaCall |
    mfaCall.getContainer() = authCall.getContainer() and
    (
...
select authCall, "Potential insecure EHR authentication detected. HIPAA compliance requires strong authentication."