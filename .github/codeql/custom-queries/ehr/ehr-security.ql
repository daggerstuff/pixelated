...
/**
 * A source of credentials for EHR systems.
 */
...
/**
 * Configuration for detecting insecure EHR credential logging or exposure.
 */
...
/**
 * Configuration for detecting unsafe access to EHR endpoints from remote sources.
 */
