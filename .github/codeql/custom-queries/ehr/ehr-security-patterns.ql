...
module InsecureEHRConfig {
  import DataFlow::Global<InsecureEHRConfigSig>
}
...
select sink, "Potential EHR security issue: sensitive data flows from $@ to a dangerous sink.", source, "this source"
