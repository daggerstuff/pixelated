 ...
 * @description Detects FHIR resource access without proper validation in the same function
 * @kind problem
...
select resourceCall,
  "FHIR resource access without validation detected in the same function. Ensure proper validation before access."
