...
3. Analyze the incident data and formulate a triage hypothesis: identify likely
...
4. Search GitHub for recent commits, PRs, or deployments to the affected service
