...
Create a complete TypeSpec API plugin for Microsoft 365 Copilot that integrates
...
1. **Operation Names**: Use clear, action-oriented names (listProjects,
   createTicket)
...
7. **Confirmations**: Add for destructive operations (delete, update critical
   data)
