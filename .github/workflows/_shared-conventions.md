...
1. github.com -> Settings -> Developer settings -> Personal access
   ...
   Recommended: fine-grained PAT scoped to _this single repo_ with an
...
5. **Bitbucket path conditions** — use Bitbucket-native `changesets.includePaths`
   on per-step conditions (already applied to AI validation steps).
