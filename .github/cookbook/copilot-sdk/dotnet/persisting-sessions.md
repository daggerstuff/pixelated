...
You want users to be able to continue a conversation even after closing and
reopening your application.

> **Runnable example:**
> [recipe/persisting-sessions.ts](recipe/persisting-sessions.ts)
>
> ```bash
...
3. **Clean up old sessions**: Periodically delete sessions that are no longer
   needed
