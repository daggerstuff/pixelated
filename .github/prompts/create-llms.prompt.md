...
following the official llms.txt specification at
[llms.txt specification](https://llmstxt.org/). This file provides high-level
guidance to large language models (LLMs) on where to find relevant content for
understanding the repository's purpose and specifications.
...
- Review the official specification at
  [llms.txt specification](https://llmstxt.org/) to ensure full compliance
...
2. **Blockquote Summary**: Brief description in blockquote format (optional but
   recommended)
3. **Additional Details**: Zero or more markdown sections without headings for
   context
4. **File List Sections**: Zero or more H2 sections containing markdown lists of
   links
