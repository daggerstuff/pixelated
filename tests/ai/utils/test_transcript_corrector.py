...
from ai.tools.utilities.core.utils.transcript_corrector import TranscriptCorrector
...
class TestTranscriptCorrector:
    ...
    @patch("ai.tools.utilities.core.utils.transcript_corrector.Path.exists")
