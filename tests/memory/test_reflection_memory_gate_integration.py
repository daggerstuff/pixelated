...
class MockMemoryManager:
    ...
    def add_memory(self, content: str, user_id: str, metadata: any, category: str) -> str | None:
        ...
        if any(p in content for p in pii_patterns):
            return None
...
def test_add_memory_preserves_metadata_for_stored_content():
    ...
    session_id = meta.session_id if hasattr(meta, "session_id") else meta.get("session_id")
    tags = meta.tags if hasattr(meta, "tags") else meta.get("tags")
