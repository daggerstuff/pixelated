def test_crisis_detector_class_exists():
    from ai.tools.utilities.core.pipelines.quality.production_crisis_detector import ProductionCrisisDetector
...
def test_crisis_detector_flags_emergency():
    from ai.tools.utilities.core.pipelines.quality.production_crisis_detector import (
        CrisisLevel,
