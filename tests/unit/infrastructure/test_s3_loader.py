...
def test_s3_loader_class_exists():
    from ai.pkg_mera.core.utils.s3_dataset_loader import S3DatasetLoader
...
def test_s3_loader_helper_functions():
    from ai.pkg_mera.core.utils.s3_dataset_loader import get_s3_dataset_path, load_dataset_from_s3
