...
describe('AgentConfigSchema', () => {
  ...
  it('rejects missing endpoint', () => {
    expect(() => AgentConfigSchema.parse({ tools: [] })).toThrow()
  })
...
describe('SlackConfigSchema', () => {
  ...
  it('rejects invalid webhook URL', () => {
    expect(() => SlackConfigSchema.parse({ webhook: 'not-a-url' })).toThrow()
  })
})
...
describe('HookConfigSchema', () => {
  ...
  it('rejects missing agent', () => {
    expect(() => HookConfigSchema.parse({ tool: 'audit' })).toThrow()
  })

  it('rejects missing tool', () => {
    expect(() => HookConfigSchema.parse({ agent: 'content' })).toThrow()
  })
})
