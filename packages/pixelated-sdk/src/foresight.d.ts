...
export declare const ForesightMemory: z.ZodObject<{
    ...
    retention: z.ZodDefault<z.ZodOptional<z.ZodEnum<{
        ephemeral: "ephemeral";
        short_term: "short_term";
        long_term: "long_term";
        permanent: "permanent";
    ...
    emotionalContext: z.ZodOptional<z.ZodObject<{
...
export declare class ForesightClient {
     ...
     * POST /api/v1/memory
     */
    storeMemory(input: z.infer<typeof StoreMemoryInput>): Promise<z.infer<typeof StoreMemoryOutput>>;
    /**
     * Retrieve a single memory by ID.
     *
     * GET /api/v1/memory/:memoryId
     */
    getMemory(input: z.infer<typeof GetMemoryInput>): Promise<z.infer<typeof ForesightMemory>>;
    /**
     * Query memories using keyword + semantic (hybrid) retrieval.
     *
     * GET /api/v1/memory/search?q=...
     */
    queryMemories(input: z.infer<typeof QueryMemoriesInput>): Promise<z.infer<typeof ListMemoriesOutput>>;
    /**
     * List memories with optional filtering.
     *
     * GET /api/v1/memory?limit=...&offset=...
     */
    listMemories(input?: z.infer<typeof ListMemoriesInput>): Promise<z.infer<typeof ListMemoriesOutput>>;
    /**
     * Update a memory record.
     *
     * PATCH /api/v1/memory/:memoryId
     */
    updateMemory(input: z.infer<typeof UpdateMemoryInput>): Promise<z.infer<typeof ForesightMemory>>;
    /**
     * Delete a memory record.
     *
     * DELETE /api/v1/memory/:memoryId
     */
    deleteMemory(input: z.infer<typeof DeleteMemoryInput>): Promise<z.infer<typeof DeleteMemoryOutput>>;
}
