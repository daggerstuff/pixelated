...
export default defineConfig({
  ...
  test: {
    ...
    // Keep file isolation enabled in CI as well. Vitest 3+ is less forgiving of
    // cross-file state leakage, and the full GitHub Actions suite should match
    // local isolation semantics to avoid order-dependent failures.
    isolate: true,
