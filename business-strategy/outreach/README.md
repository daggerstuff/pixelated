...
This folder holds templates, proposals, and trackers for institutional pilot
outreach.
...
**Progression:** Lead → Email Sent → Meeting Scheduled → Proposal Sent →
...
- **Status:** Legacy field; keep for backward compatibility (e.g. "Email Sent",
  "Pending Response").
- **Pipeline Stage:** Set to one of the stages above. Update when the
  opportunity moves.
...
- [pilot-agreement-template.md](pilot-agreement-template.md) – Agreement
  checklist
