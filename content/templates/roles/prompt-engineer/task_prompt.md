...
1. Read the existing prompt templates and renderer before editing — understand
   variable substitution rules
2. Use `{{VARIABLE}}` for required substitutions; wrap optional sections in
   `{{#IF VAR}}...{{/IF}}`
3. Write prompts for the actual model, not an idealized one — be concrete and
   directive
