...
const databaseUrl = process.env.DATABASE_URL || 'postgresql://***REMOVED***@ep-falling-dew-a8eovkvn-pooler.eastus2.azure.neon.tech/neondb?channel_binding=require&sslmode=require'
